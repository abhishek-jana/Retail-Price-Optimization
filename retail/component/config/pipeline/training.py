...
from retail.entity.config_entity import DataIngestionConfig, TrainingPipelineConfig
from retail.constant.training_pipeline_config import *
from retail.constant import TIMESTAMP
...
from retail.entity.metadata_entity import DataIngestionMetadata
